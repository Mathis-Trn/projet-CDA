<template>
    <div style="background-color: white; padding: 8rem; @apply isolate bg-white px-6 py-24 sm:py-32 lg:px-8;">
        ...
        <div style="margin-inline-start: auto; margin-inline-end: auto; max-width: 2xl; text-align: center; @apply mx-auto max-w-2xl text-center;">
            <h2 style="font-size: 1.875rem; line-height: 2.25rem; font-weight: 700; letter-spacing: -0.025em; color: #374151; @apply text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl;">Créer un nouvel Auteur</h2>
            <p style="margin-top: 0.5rem; font-size: 1.125rem; line-height: 1.75rem; color: #4b5563; @apply mt-2 text-lg leading-8 text-gray-600;">Remplissez les champs pour créer un nouvel Auteur</p>
        </div>
        <form @submit.prevent="createAuthor" style="margin-inline-start: auto; margin-inline-end: auto; margin-top: 4rem; max-width: xl; @apply mx-auto mt-16 max-w-xl sm:mt-20;">
            <div style="display: grid; grid-template-columns: 1fr; gap: 0.75rem 2rem; @apply grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2;">
                ...
                <div>
                    <label for="adress" style="font-size: 0.875rem; font-weight: 600; line-height: 1.25rem; color: #374151; @apply block text-sm font-semibold leading-6 text-gray-900;">Adresse</label>
                    <div style="margin-top: 0.625rem; @apply mt-2.5;">
                        <input type="text" id="adress" style="width: 100%; border-radius: 0.375rem; border-width: 0; padding-inline: 0.875rem; padding-block: 0.5rem; color: #374151; box-shadow: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.05); border-color: #d1d5db; placeholder-color: #9ca3af; outline-width: 0; outline-offset: 0; outline-style: auto; outline-color: initial; outline-width: 2px; outline-style: inset; outline-color: #2563eb; @apply block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6;">
                    </div>
                </div>
                <div>
