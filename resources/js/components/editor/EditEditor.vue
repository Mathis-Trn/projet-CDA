<template>
    <div style="background-color: white; padding: 8rem; @apply isolate bg-white px-6 py-24 sm:py-32 lg:px-8;">
        ...
        <form @submit.prevent="updateEditorData" style="margin-inline-start: auto; margin-inline-end: auto; margin-top: 4rem; max-width: xl; @apply mx-auto mt-16 max-w-xl sm:mt-20;">
